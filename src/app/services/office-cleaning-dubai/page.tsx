...
const service = SERVICES.find((s) => s.slug === "office-cleaning-dubai")!;
const content = SERVICE_CONTENT["office-cleaning-dubai"];
...
export default function OfficeCleaningDubaiPage() {
  return (
    <>
      <ServiceSchema
        name={service.title}

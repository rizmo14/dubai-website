...
const service = SERVICES.find((s) => s.slug === "villa-cleaning-dubai")!;
const content = SERVICE_CONTENT["villa-cleaning-dubai"];
...
export default function VillaCleaningDubaiPage() {
  return (
    <>
      <ServiceSchema
        name={service.title}

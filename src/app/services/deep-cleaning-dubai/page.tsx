...
const service = SERVICES.find((s) => s.slug === "deep-cleaning-dubai")!;
const content = SERVICE_CONTENT["deep-cleaning-dubai"];
...
export default function DeepCleaningDubaiPage() {
  return (
    <>
      <ServiceSchema
        name={service.title}
